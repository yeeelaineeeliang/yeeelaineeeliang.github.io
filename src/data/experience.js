export const experience = [
  {
    ...
    location: 'Chicago, IL',
    tags: ['LLM Prompting', 'RAG', 'Android / Kotlin', 'Human-Robot Interaction'],
    description:
      'Built the memory and conversation layer for a Temi social robot — connecting LLM prompt design, retrieval logic, and Android/Kotlin deployment within a 2×2 randomized study design where every engineering decision had to be traceable and research-valid.',
    achievements: [
  ...
  },
  {
    ...
    achievements: [
      'Segmented 40k+ customers into five behavioral groups with KMeans and PCA — one cluster was consistently underserved across every channel, which shifted how the team thought about budget allocation.',
      'Cut mobile transaction completion time by 57% by mapping a legacy flow with three other teams and removing steps that existed only because they always had.',
    ],
  },
  {
    ...
    achievements: [
      ...
      'Designed the database schema and prompt templates that structured GPT output into consistent, queryable fields — built and handed off in two weeks.',
    ],
  },
]
