    ...
    <section id="about" className="section bg-bg-alt">
      <div className="container-content">
        ...
        <div className="fade-in mb-6 max-w-2xl">
          ...
          <h2 className="text-3xl sm:text-4xl font-semibold leading-[1.24] max-w-[820px]">
            I look for{' '}
        ...
        <div className="fade-in mb-8">
          ...
          <div className="border border-border border-t-2 border-t-gold rounded bg-surface p-0">
            <div className="grid grid-cols-1 sm:grid-cols-3 divide-y sm:divide-y-0 sm:divide-x divide-border/40">
              {APPROACH_STEPS.map(({ n, verb, problem, question }) => (
                <div key={n} className="p-8 transition-colors duration-300 hover:bg-accent/[0.035]">
                  ...
                  <p className="text-base font-bold text-text mb-2">{problem}</p>
        ...
        <div className="fade-in border-t border-border pt-14">
          <p className="text-lg font-semibold text-text mb-6">What I build with</p>
              ...
              <div key={label}>
                ...
                <div className="flex flex-wrap gap-1.5">
                  {items.map(name => (
                    <span
                      key={name}
                      className="rounded-full border border-border bg-surface px-3 py-1 font-mono text-xs text-muted transition-all duration-200 hover:border-accent hover:text-accent hover:-translate-y-px"
                    >
                      {name}
                    </span>
                  ))}
